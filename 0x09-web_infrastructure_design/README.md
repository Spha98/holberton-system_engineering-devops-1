...
[0-simple_web_stack](0-simple_web_stack) <br />
...
[1-distributed_web_infrastructure](1-distributed_web_infrastructure) <br />
...
* 1 application files (your code base)
* 1 database (MySQL)
[2-secured_and_monitored_web_infrastructure](2-secured_and_monitored_web_infrastructure) <br />
